...
def menu(my_name,my_id):
	...
	cetak(panel(f'[[bold green]•[/][bold white]][/] [bold white][bold cyan]Author : [bold green]BintangTzy[/]\n[[bold green]•[/][bold white]][/] [bold white]Recode : [bold green]XyzonXD[/]\n[[bold green]•[/][bold white]][/] [bold white]Versi  : [bold green]2.1[/][/]\n[[bold green]•[/][bold white]][/] [bold white]Status : [bold green]Private[/][/] ',width=44,padding=(0,0),style=f"bold white"))
