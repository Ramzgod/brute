...
def menu(my_name,my_id):
	...
	cetak(panel(f'[bold white][+][/][bold white]][/] [bold white]Author : [bold green]BintangTzy[/]\n[bold white][+[/][bold white]][/] [bold white]Recode : [bold green]XyzonXD[/]\n[bold white][+[/][bold white]][/] [bold white]Versi  : [bold green]2.1[/][/]\n[bold white][+[/][bold white]][/] [bold white]Status : [bold green]Private[/][/] ',width=44,padding=(0,3),style=f"bold white"))
