...
def menu(my_name,my_id):
	...
	cetak(panel(f'[bold white][[bold green]•[/][bold white]][/] [bold cyan]Username : [bold green]{my_name}[/]\n[bold white][[bold green]•[/][bold white]][/] [bold cyan]User Idz : [bold green]{my_id}[/]\n[bold white][[bold green]•[/][bold white]][/] [bold cyan]User Ip  : [bold green]{ip}[/][/][bold white]\n[[bold green]•[/][bold white]][/] [bold cyan]Status   : [bold green]Premium ',width=45,title=f"[bold green]Infomasi",style=f"bold white"))
	cetak(panel(f'[[bold green]•[/][bold white]][/] [bold white][bold cyan]Author : [bold green]BintangTzy[/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]Recode : [bold green]XyzonXD[/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]Versi  : [bold green]2.1[/][/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]Status : [bold green]Private[/][/] ',width=44,padding=(0,0),style=f"bold white"))
...
#-------------------[ DOA HALAL ]-----------------------#
def doa_halal():
	cetak(nel(f'''{H2}[{K2}+{H2}] {H2}Versi Arab Stay Halal : [bold cyan]                      
