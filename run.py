...
def loginkontol():
    if "sukses" in lisensiku:
        try:
            ...
            if loginpil in [""]:prints(Panel(f"{P2}Harap Masukan Pilihan Yang Bener Jangan Sampai Salah!",width=100,padding=(0,12),style=f"{color_table}"));time.sleep(3);loginkontol()
            elif loginpil in ["1","01"]:loginCookie()
            elif loginpil in ["2","02"]:prints(Panel(f"{P2}Mohon Maaf Sementara Login Menggunakan Username & Password Di Nonaktifkan",width=100,padding=(0,1),style=f"{color_table}"));time.sleep(3);loginkontol()
            elif loginpil in ["3","03"]:exit()
            else:prints(Panel(f"{P2}Harap Masukan Pilihan Yang Bener Jangan sampai Salah!",width=100,padding=(0,12),style=f"{color_table}"));time.sleep(3);loginkontol()
        ex,user=cekAPI(kuki)
        cookie={'cookie':kuki}
